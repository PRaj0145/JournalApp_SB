...
import com.rootZero.journalApp.service.JournalEntryService;
...
@RestController
@RequestMapping("/journal") public class JournalEntryControllerV2 {
    ...
    @PutMapping("id/{myId}")
    public ResponseEntity<?> putJouranalEntryById(
